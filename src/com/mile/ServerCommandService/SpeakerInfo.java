...
/**
 * <p>Java class for SpeakerInfo complex type.
 * 
 ...
 *         &lt;element name="SpeakerSecurity" type="{http://videoos.net/2/XProtectCSServerCommand}SpeakerSecurityInfo" minOccurs="0"/>
...
@XmlType(name = "SpeakerInfo", propOrder = {
    "tracks",
    "speakerSecurity",
    "multicastEnabled",
    ...
    extends DeviceInfo
{
    ...
    @XmlElement(name = "SpeakerSecurity")
    protected SpeakerSecurityInfo speakerSecurity;
    ...
    /**
     * Gets the value of the speakerSecurity property.
     * 
     * @return
     *     possible object is
     *     {@link SpeakerSecurityInfo }
     *     
     */
    public SpeakerSecurityInfo getSpeakerSecurity() {
        return speakerSecurity;
    }

    /**
     * Sets the value of the speakerSecurity property.
     * 
     * @param value
     *     allowed object is
     *     {@link SpeakerSecurityInfo }
     *     
     */
    public void setSpeakerSecurity(SpeakerSecurityInfo value) {
        this.speakerSecurity = value;
    }
